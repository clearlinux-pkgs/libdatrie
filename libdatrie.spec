...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604442506
...
cp %{_builddir}/libdatrie-0.2.12/COPYING %{buildroot}/usr/share/package-licenses/libdatrie/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd ../build32/
%make_install32
