...
Version  : 0.2.11
Release  : 7
URL      : ftp://linux.thai.net/pub/thailinux/software/libthai/libdatrie-0.2.11.tar.xz
Source0  : ftp://linux.thai.net/pub/thailinux/software/libthai/libdatrie-0.2.11.tar.xz
...
%prep
%setup -q -n libdatrie-0.2.11
pushd ..
cp -a libdatrie-0.2.11 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1526833887
...
/usr/lib64/libdatrie.so.1.3.4

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libdatrie.so.1
/usr/lib32/libdatrie.so.1.3.4
